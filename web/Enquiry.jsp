...
<h1>What's About Enquiry Person</h1>
            <form action="Enquiry">
                <div class="col-sm-6">
                <label>Name:</label>
                ...
                <input type="text" placeholder="Enter Your Semester" name="semester"
                class="form-control" required></div>
                <div class="col-sm-6">
                <label>Branch:</label>
                ...
                <div class="col-sm-6">
                <label>refer_by:</label>
                <input type="text" placeholder="Who Refer you??" name="refered" class="form-control"></div>
               
                <div class="col-sm-6">
                 <label>Course:</label>
                <input type="text"  name="course" placeholder="What do you Want To learn??" class="form-control"></div>
                <br>
				<br>
               <div class="col-sm-6">
                <label>Counselor:</label>
                <input type="text" placeholder="Enter Consellor's Name" name="counselor" class="form-control"></div>
