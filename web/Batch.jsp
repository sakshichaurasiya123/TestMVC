...
<div class="col-sm-8 background">
    <h1>What's About New Batch</h1>
            <form action="Batch">
                <div class="col-sm-6">
                <label>Batch Name:</label>
                <input type="text" placeholder="Enter Batch Name" name="batch_name"
                ...
                <input type="time"  name="batch_timing" class="form-control" required></div>
                <br><br>
              	  <div class="col-sm-6"><label>Faculty</label><br>
                 <select name="faculty" class="form-control">
                     <option value="0">Select Faculty
                     <%
