...
<h1>What's About Faculty</h1>
		...
		<input type="radio" value="male" name="gender" required>&nbsp;&nbsp;Male</div>
                <br><br><br><br>
                 <div class="col-sm-6">
                <label>Qualification:</label>
                <input type="text" name="qualification" placeholder="Enter Your Qualification" class="form-control"
                 required></div>
                <div class="col-sm-6"><label>Specialization</label>
                <input type="text" placeholder="Like-Php,Python,Java etc" name="specialization" 
                class="form-control" required></div>
                ...
                <input type="text" placeholder="Enter Your Work Experience" name="experience"
                class="form-control" required></div>
               
                <div class="col-sm-6">
                <label> Residental Address:</label>
                <textarea placeholder="Enter Your Residental Address" name="address"
                class="form-control" required></textarea></div>
                
                <br><br><br><br>
                

                <center><div class="col-sm-12"><input type="submit" name="register" value="REGISTER">&nbsp;&nbsp;
