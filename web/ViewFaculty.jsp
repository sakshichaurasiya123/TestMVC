...
<%@page import="com.universal.model.CourseDTO"%>
<%@page import="com.universal.model.StudentDAO"%>
...
<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Faculty
<span class="caret"></span></a>
	<ul class="dropdown-menu">
...
<th>Delete</th>
    ...
    <%
        ...
        while(rs.next())
        {
            ...
            out.print("<td><a href='DeleteFaculty.jsp?id="+rs.getString(1)+"' class='btn btn-warning'>Delete</a></td></tr>");
