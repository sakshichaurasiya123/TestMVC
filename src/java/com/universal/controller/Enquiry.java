...
import com.universal.model.EnquiryDTO;
...
public class Enquiry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String refered= request.getParameter("refered");
            String course= request.getParameter("course");
            String counselor= request.getParameter("counselor");
            String mobile= request.getParameter("mobile");
            String email= request.getParameter("email");
            
            EnquiryDTO edto= new EnquiryDTO(name, college, semester, branch, refered, course, counselor, mobile, email);
            StudentDAO sdao= new StudentDAO();
            
            boolean b=sdao.enquiry(edto);
            if(b)
                {
