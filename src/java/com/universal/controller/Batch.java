...
import com.universal.model.BatchDTO;
...
public class Batch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String batchTiming=request.getParameter("batch_timing");
            String faculty=request.getParameter("faculty");
            String course=request.getParameter("course");
            
            BatchDTO bdto=new BatchDTO(batchName, startDate, duration, batchTiming, faculty, course);
            StudentDAO sdao= new StudentDAO();
            boolean b=sdao.batch(bdto);
                if(b)
                {
